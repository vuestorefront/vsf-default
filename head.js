export default {
  ...
  link: [
    ...
    { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Playfair+Display:400,700|Roboto:400,700|Material+Icons&display=swap', media: 'print', onload: "this.media='all'" },
